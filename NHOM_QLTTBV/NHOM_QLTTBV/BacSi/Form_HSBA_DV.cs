...
{
    public partial class Form_HSBA_DV : Form
    {
        DataTable dt;
        private String username = "";
        private String dbname = "";
        public Form_HSBA_DV(String username, String dbname)
        {
        ...
        {
            string sql = "select * from U_AD.View_YBacSi_Select_KetQua_HSBADV";
            ...
            dgv_HSBA.Columns[8].HeaderText = "Kết quả";
        ...
        private void Form_HSBA_DV_Load(object sender, EventArgs e)
        {
            load_Data();
        }
    }
