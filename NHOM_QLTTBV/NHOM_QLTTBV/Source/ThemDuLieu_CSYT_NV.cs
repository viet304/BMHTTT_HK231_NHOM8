...
namespace NHOM_QLTTBV.Source
{
    public partial class ThemDuLieu_CSYT_NV : Form
    {
        ...
        private void btn_capnhat_NV_Click(object sender, EventArgs e)
        {
            ...
            NHOM_QLTTBV.Source.Form1_capnhat_NhanViencs capnhat_NhanVien = new Form1_capnhat_NhanViencs(
        ...
        {
            NHOM_QLTTBV.Source.Form_them_NV them_nv = new Form_them_NV();
        ...
        {
            NHOM_QLTTBV.Source.Form_them_CSYT them_CSYT = new Form_them_CSYT();
        ...
        {
            NHOM_QLTTBV.Source.From_capnhat_CSYT capnhat_CSYT = new From_capnhat_CSYT(
