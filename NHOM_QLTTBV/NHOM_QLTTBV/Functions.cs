...
namespace NHOM_QLTTBV
{
    public class Functions
    {
        ...
        public static void InitConnection(String username, String password)
        {
            ...
            //string connectionString = CreateConnectionString("localhost", "1521", "orcl.localdomain", "U_AD", "0");
            // string connectionString = "Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=localhost)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=orcl.localdomain)));User ID=U_AD;Password=0;";
            string connectionString = CreateConnectionString("localhost", "1521", "orcl.localdomain", username, password);
        ...
        static string CreateConnectionString(string server, string port, string serviceName, string username, string password)
        {
            string connectionString = $"Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST={server})(PORT={port}))(CONNECT_DATA=(SERVICE_NAME={serviceName})));User Id={username};Password={password};";
